...
const void *array_list_back(const void *list) {
    const ArrayList *l = (const ArrayList *)list;
    return ArrayListBack(l);
}

void array_list_push_back(void *list, void *value) {
    ArrayList *l = (ArrayList *)list;
    return ArrayListPushBack(l, value);
}

void *array_list_pop_back(void *list) {
    ArrayList *l = (ArrayList *)list;
    return ArrayListPopBack(l);
}

size_t array_list_size(const void *list) {
    return ArrayListSize((const ArrayList *)list);
}

bool array_list_is_empty(const void *list) {
